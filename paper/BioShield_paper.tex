% =============================================================================
% BioShield — IEEE Conference Paper (single-file flattened draft)
%
% Template : IEEEtran.cls (conference mode)
% Compile  : pdflatex BioShield_paper  &&  bibtex BioShield_paper
%            pdflatex BioShield_paper  &&  pdflatex BioShield_paper
% Requires : refs.bib + figures/*.png in the same directory
%
% Title    : BioShield: A Negative Result on Adversarial Retraining for
%            Biomedical AI-Text Detection Under Generator-Family Shift
% Author   : Venkata Rayudu Alapati  (AP25122040029)
% =============================================================================
