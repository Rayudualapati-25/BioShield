...
optimisation \cite{rafailov2023dpo} suggests that generator hardening via
explicit reward signals may produce stronger adversaries than REINFORCE-based
training — a conjecture our flat Condition~B curve is consistent with,
though we do not claim those papers establish the comparison directly.
...
consistent with the broader paraphrase-attack literature
\cite{sadasivan2024aigeneratedtext,krishna2023paraphrasing}; we attribute
the plateau to in-family generator--detector alignment rather than to any
